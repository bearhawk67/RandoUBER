...
STRAT_PARAMS = {
    ...
    "guppy": {
        ...
        "ltp1_qty": {"name": "% of trade to close at TP1 (long)", "type": float, "min": 0.1, "max": 100.0,
                     "decimals": 1},
        "ltp2": {"name": "TP2 (%) for longs", "type": float, "min": 0.4, "max": 10.0, "decimals": 1},
        "ltp2_qty": {"name": "% of trade to close at TP2 (long)", "type": float, "min": 0.1, "max": 100.0,
                     "decimals": 1},
        ...
        "stp1_qty": {"name": "% of trade to close at TP1 (short)", "type": float, "min": 0.1, "max": 100.0,
                     "decimals": 1},
        "stp2": {"name": "TP2 (%) for shorts", "type": float, "min": 0.4, "max": 10.0, "decimals": 1},
        "stp2_qty": {"name": "% of trade to close at TP2 (short)", "type": float, "min": 0.1, "max": 100.0,
                     "decimals": 1},
        "stp3": {"name": "TP3 (%) for shorts", "type": float, "min": 0.5, "max": 10.0, "decimals": 1},
    }
}
